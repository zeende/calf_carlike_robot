...
echo "`rospack find serial_port`/serial_port_sh/rplidar/rplidar.rules"
sudo cp `rospack find serial_port`/serial_port_sh/rplidar/rplidar.rules  /etc/udev/rules.d
echo " "
